               ...
               <!--  <option value="First">First</option>
                ...
                <?php 
                 require_once ("../../include/initialize.php");
                  $mydb->setQuery("SELECT * FROM `subject` s inner join tblschedule sc on s.SUBJ_ID=sc.SUBJ_ID inner join tblinstructor i on sc.INST_ID=i.INST_ID WHERE i.INST_ID= ".$_POST['id']);
